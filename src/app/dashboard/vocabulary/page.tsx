      ...
      <div className="mx-auto max-w-4xl">
        <header className="mb-12">
          ...
          <p className="text-muted-foreground mt-4 text-lg">
            Words and flashcards you've saved while reading lessons.
          </p>
        </header>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-card border border-border rounded-3xl p-6 shadow-xl mb-8">
          ...
          <div className="flex items-center gap-2 bg-muted p-1 rounded-2xl shrink-0 w-full md:w-auto">
            ...
            >
              <LayoutGrid className="h-4 w-4" /> Bảng Từ
            </button>
            <button 
            ...
            >
              <Play className="h-4 w-4" /> Luyện tập
            </button>
          </div>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-24 gap-4 text-muted-foreground">
            ...
            <p className="font-bold">Loading your flashcards...</p>
          </div>
            ...
            <div className="flex flex-col items-center justify-center py-8">
               <div className="w-full max-w-md">
                 <div className="flex items-center justify-between mb-8 px-4 text-muted-foreground font-bold">
                    <span>Card {currentIndex + 1} / {filteredVocab.length}</span>
                    <span className="text-xs uppercase tracking-widest bg-muted px-3 py-1 rounded-full">Practice Mode</span>
                 </div>
          ...
          <div className="text-center py-24 border-2 border-dashed border-border rounded-3xl bg-muted/10">
            ...
            <h3 className="text-xl font-black text-foreground mb-2">No words found!</h3>
            <p className="text-muted-foreground max-w-md mx-auto mb-8">
              {search 
                ? "Couldn't find any words matching your search." 
                : "You haven't saved any words yet. Read lessons and double-click any word to save it to your flashcards."}
            </p>
            <Link 
              href="/roadmaps"
