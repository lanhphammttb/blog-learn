      ...
      <div className="mx-auto max-w-7xl py-12">
        ...
        <div className="text-center mb-24">
          ...
          <h1 className="text-4xl font-black tracking-tight text-foreground sm:text-7xl mb-6">
            {t('hero_title_start')}<span className="gradient-text">{t('hero_title_highlight')}</span>{t('hero_title_end')}
          </h1>
          ...
          <div className="mb-24">
             <div className="mb-8 flex items-center justify-between">
                <div className="flex items-center gap-3">
                   ...
                   <h2 className="text-2xl font-black text-foreground uppercase tracking-tight">{t('structured_paths')}</h2>
                </div>
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-2xl font-black text-foreground uppercase tracking-tight">{t('latest_lessons')}</h2>
        </div>
          ...
          {allArticles.length > 0 ? (
            allArticles.map((article: any) => (
             ...
             <div className="col-span-full py-20 text-center">
                <h3 className="text-xl font-medium text-foreground mb-2">{t('no_lessons')}</h3>
                <Link
                  href="/admin/new"
